...
export default function Aurora({
  colorStops = ["#ffc100", "#e9cf7c", "#f2f2f2"],
  amplitude = 1.0,
  blend = 0.5,
  speed = 1.0,
  time,
  ...
  useEffect(() => {
    ...
    program = new Program(gl, {
      ...
      uniforms: {
        ...
        uResolution: {
          value: [container.offsetWidth || window.innerWidth, container.offsetHeight || window.innerHeight],
        },
    ...
    const update = (frameTime) => {
      ...
      const currentTime =
        typeof currentProps.time === "number" ? currentProps.time : frameTime * 0.01;

      program.uniforms.uTime.value = currentTime * currentProps.speed * 0.1;
